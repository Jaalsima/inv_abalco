...
CREATE TABLE `detalle_compra` (
    `id_det_compra` VARCHAR(10) COLLATE UTF8MB4_UNICODE_CI,
...
CREATE TABLE `detalle_venta` (
    `id_det_venta` VARCHAR(10) COLLATE UTF8MB4_UNICODE_CI,
...
CREATE TABLE `movimiento` (
    ...
    `fk_id_det_compra` VARCHAR(10) COLLATE UTF8MB4_UNICODE_CI DEFAULT NULL,
    `fk_id_det_venta` VARCHAR(10) COLLATE UTF8MB4_UNICODE_CI DEFAULT NULL,
    `cantidad_comprada` INT(10) DEFAULT NULL,
    `cantidad_vendida` INT(10) DEFAULT NULL,
    ...
    CONSTRAINT `alias_fk_id_prod_3` FOREIGN KEY (`fk_id_prod`)
        REFERENCES `producto` (`id_prod`),
    CONSTRAINT `alias_fk_id_det_compra_2` FOREIGN KEY (`fk_id_det_compra`)
        REFERENCES `detalle_compra` (`id_det_compra`),
    CONSTRAINT `alias_fk_id_det_venta_2` FOREIGN KEY (`fk_id_det_venta`)
