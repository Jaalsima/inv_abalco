...
if (isset($_POST['actualizar'])) {
    ...
    $_SESSION["mensaje_prov"] = "¡Los datos de este proveedor han sido actualizados exitosamene!";
    $_SESSION["tipo_mensaje_prov"] = "primary";
    header("Location: proveedor.php");
}
        ...
        <div class="col-md-4 mx-auto">
            <div class="card card-body bg-info">
                <form action="editar_proveedor.php?id=<?php echo $_GET['id']; ?>" method="POST"> <?php //Aqui estoy capturando el id de los productos 
                    ...
                    <div class="form-group">
                        <input type="text" name="dir_prov" value="<?php echo $dir; ?>" class="form-control" placeholder="Dirección Proveedor">
                    </div>

                    <div class="form-group">
                        <input type="text" name="tel_prov" value="<?php echo $tel; ?>" class="form-control" placeholder="Teléfono Proveedor">
                    </div>

                    <div class="form-group">
                        <input type="email" name="email_prov" value="<?php echo $email; ?>" class="form-control" placeholder="Email Proveedor">
                    </div>
